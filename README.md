...
avant tout, si un proxy est cinfigurer sur le réseaau utiliser, alors il est nécessaire de modifier le script au début de ce dernier, et d'indiquer le proxy 
